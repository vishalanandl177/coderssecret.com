export const CONTENT = `
      <p>Ethical hacking - also called <strong>penetration testing</strong> or <strong>white-hat hacking</strong> - is the practice of legally breaking into systems to find vulnerabilities <em>before</em> malicious hackers do. It's one of the most in-demand skills in cybersecurity, and you don't need a CS degree to get started. This tutorial will take you from zero to running your first penetration test, step by step. Use the <a href="/blog/api-security-attacks-defense-guide">API attack and defense guide</a> for application-layer examples, then practise choosing controls in the <a href="/games/api-attack-defense">API Attack &amp; Defense game</a>.</p>
