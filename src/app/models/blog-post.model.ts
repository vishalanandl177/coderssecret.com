...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'Compare Snowflake, Databricks, BigQuery, and e6data through the production decisions that matter: storage, compute, governance, table formats, cost control, and workload fit.',
    category: 'devops',
    featured: true,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['Data Engineering', 'Snowflake', 'Databricks', 'BigQuery', 'e6data', 'Lakehouse', 'Warehouse'],
    coverImage: '',
  },
  {
    id: '98',
    title: 'Bronze, Silver, and Gold Data Layers Explained',
    slug: 'bronze-silver-gold-data-layers-explained',
    excerpt: 'Learn how bronze, silver, and gold layers organize raw events, cleaned facts, and business-ready datasets without turning your lakehouse into a pile of duplicated tables.',
    category: 'tutorials',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '9 min read',
    tags: ['Data Engineering', 'Lakehouse', 'Medallion Architecture', 'dbt', 'Data Quality'],
    coverImage: '',
  },
  {
    id: '97',
    title: 'Why Spark Jobs Become Slow: Shuffle, Skew, Partitions, and Memory',
    slug: 'why-spark-jobs-become-slow-shuffle-skew-partitions-memory',
    excerpt: 'Spark jobs usually slow down for predictable reasons: too much shuffle, skewed keys, bad partition sizing, expensive file layouts, and memory pressure. Learn how to debug each one.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    ...
    tags: ['Spark', 'Data Engineering', 'Performance', 'Shuffle', 'Skew', 'Partitions', 'Memory'],
    coverImage: '',
  },
  {
    id: '96',
    title: 'Kubernetes Secrets vs Vault vs Workload Identity',
    slug: 'kubernetes-secrets-vault-workload-identity',
    excerpt: 'Understand when Kubernetes Secrets are enough, when Vault adds real value, and why workload identity removes long-lived credentials from production service-to-service flows.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['Kubernetes', 'Secrets', 'Vault', 'Workload Identity', 'SPIFFE', 'Security', 'Zero Trust'],
    coverImage: '',
  },
  {
    id: '95',
    title: 'Software Supply Chain Security Explained',
    slug: 'software-supply-chain-security-explained',
    excerpt: 'Software supply chain security is not one scanner. Learn how source control, CI runners, dependencies, artifacts, SBOMs, provenance, signing, and deployment policy fit together.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['Supply Chain Security', 'SLSA', 'SBOM', 'Sigstore', 'CI/CD', 'DevSecOps'],
    coverImage: '',
  },
  {
    id: '94',
    title: 'Kubernetes Security Explained',
    slug: 'kubernetes-security-explained',
    excerpt: 'A practical map of Kubernetes security: API server access, RBAC, Pod Security, network policy, secrets, image trust, admission control, runtime detection, and audit logs.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['Kubernetes', 'Security', 'RBAC', 'Pod Security', 'NetworkPolicy', 'Runtime Security'],
    coverImage: '',
  },
  {
    id: '93',
    title: 'Common CI/CD Attack Paths',
    slug: 'common-cicd-attack-paths',
    excerpt: 'Attackers do not need production shell when the pipeline can deploy for them. Learn the common CI/CD attack paths across secrets, runners, workflows, artifacts, and environments.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['CI/CD', 'Security', 'GitHub Actions', 'Supply Chain', 'OIDC', 'Secrets'],
    coverImage: '',
  },
  {
    id: '92',
    title: 'Why Table Formats Exist in Production',
    slug: 'why-table-formats-exist-production',
    excerpt: 'Delta Lake, Apache Iceberg, and Apache Hudi exist because object storage alone is not a table. Learn what table formats add and how to choose one for production.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['Apache Iceberg', 'Delta Lake', 'Apache Hudi', 'Table Formats', 'Lakehouse', 'Data Engineering'],
    coverImage: '',
  },
  {
    id: '91',
    title: 'S3 Tables Explained',
    slug: 's3-tables-explained',
    excerpt: 'S3 Tables bring managed Apache Iceberg table storage into Amazon S3. Learn what table buckets change, what they do not change, and when they fit a lakehouse architecture.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '8 min read',
    tags: ['S3 Tables', 'AWS', 'Apache Iceberg', 'Lakehouse', 'Data Engineering'],
    coverImage: '',
  },
  {
    id: '90',
    title: 'Data Mesh vs Lakehouse: Architecture, Ownership, and Governance',
    slug: 'data-mesh-vs-lakehouse-architecture-ownership-governance',
    excerpt: 'Data mesh and lakehouse solve different problems. Learn how ownership, platform architecture, governance, catalogs, domains, and data products fit together in production.',
    category: 'devops',
    featured: false,
    content: '',
    author: 'Vishal Anand',
    date: '2026-05-31',
    readTime: '7 min read',
    tags: ['Data Mesh', 'Lakehouse', 'Governance', 'Data Products', 'Data Engineering'],
    coverImage: '',
  },
  {
    id: '89',
  ...
  {
    id: '49',
    title: 'Claude Token Costs Explained: Pricing, Caching, Claude Code & MCP',
    slug: 'claude-tokens-hidden-costs-optimization-guide',
    excerpt: 'Learn Claude token costs in 2026: Opus 4.7 pricing, prompt caching, Claude Code context, MCP overhead, thinking tokens, data residency, tool costs, and practical ways to reduce spend.',
    category: 'ai',
    featured: true,
    content: '',
    author: 'Vishal Anand',
    date: '2026-04-25',
    readTime: '20 min read',
    tags: ['Claude', 'Claude Code', 'AI', 'Tokens', 'Prompt Caching', 'MCP', 'Cost Optimization', 'Anthropic'],
    coverImage: '',
    popularRank: 2,
  },
  {
