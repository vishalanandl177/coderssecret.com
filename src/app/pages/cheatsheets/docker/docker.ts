...
export class DockerCheatsheetComponent {
  ...
  header: CheatsheetHeader = {
    ...
    intro: 'Build, run, and manage containers with the Docker commands engineers reach for during local development, CI debugging, and production incident response.',
  };
  sections: Section[] = [
    {
        "title": "Images",
